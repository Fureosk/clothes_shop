...
def init_db():
    ...
    if c.fetchone()[0] == 0:
        ...
        products = [
            ...
            ("Пуховик зимний чёрный",5999,"Мужская","Верхняя одежда","Тёплый пуховик на зиму с капюшоном","https://source.unsplash.com/400x400/?black,winter,puffer,jacket,men"),
            ("Кожаная куртка чёрная",7999,"Мужская","Верхняя одежда","Стильная кожаная куртка на молнии","https://source.unsplash.com/400x400/?black,leather,jacket,men"),
            ("Парка хаки",6499,"Мужская","Верхняя одежда","Тёплая парка с мехом и капюшоном","https://source.unsplash.com/400x400/?khaki,parka,jacket,men"),
            ("Бомбер серый",4999,"Мужская","Верхняя одежда","Стильный бомбер на осень-весну","https://source.unsplash.com/400x400/?grey,bomber,jacket,men"),
            ("Тренч бежевый",8499,"Мужская","Верхняя одежда","Классический тренчкот из плащёвки","https://source.unsplash.com/400x400/?beige,trench,coat,men"),
            ("Дутая жилетка синяя",3299,"Мужская","Верхняя одежда","Лёгкая стёганая жилетка без рукавов","https://source.unsplash.com/400x400/?blue,vest,quilted,men"),
            # ── Мужская / Футболки ──
            ("Футболка белая базовая",799,"Мужская","Футболки","Базовая хлопковая футболка оверсайз","https://source.unsplash.com/400x400/?white,tshirt,men,basic"),
            ("Футболка чёрная",799,"Мужская","Футболки","Классическая чёрная футболка из хлопка","https://source.unsplash.com/400x400/?black,tshirt,men"),
            ("Рубашка поло синяя",1299,"Мужская","Футболки","Классическая рубашка поло с воротником","https://source.unsplash.com/400x400/?blue,polo,shirt,men"),
            ("Лонгслив полосатый",1499,"Мужская","Футболки","Лонгслив в морскую полоску","https://source.unsplash.com/400x400/?striped,longsleeve,shirt,men"),
            ("Футболка с принтом",999,"Мужская","Футболки","Яркая футболка с графическим принтом","https://source.unsplash.com/400x400/?graphic,print,tshirt,men"),
            ("Рубашка клетчатая",1799,"Мужская","Футболки","Фланелевая рубашка в клетку","https://source.unsplash.com/400x400/?plaid,flannel,shirt,men"),
            # ── Мужская / Брюки ──
            ("Джинсы slim синие",2999,"Мужская","Брюки","Зауженные синие джинсы стретч","https://source.unsplash.com/400x400/?blue,slim,jeans,men"),
            ("Джинсы чёрные",2999,"Мужская","Брюки","Классические чёрные джинсы прямого кроя","https://source.unsplash.com/400x400/?black,jeans,men"),
            ("Спортивные штаны серые",1999,"Мужская","Брюки","Удобные спортивные штаны с карманами","https://source.unsplash.com/400x400/?grey,sweatpants,men,sport"),
            ("Классические брюки чёрные",3499,"Мужская","Брюки","Строгие классические брюки для офиса","https://source.unsplash.com/400x400/?black,dress,pants,men,formal"),
            ("Карго брюки хаки",3299,"Мужская","Брюки","Практичные карго с множеством карманов","https://source.unsplash.com/400x400/?khaki,cargo,pants,men"),
            # ── Мужская / Обувь ──
            ("Кроссовки белые",4999,"Мужская","Обувь","Классические белые кроссовки на каждый день","https://source.unsplash.com/400x400/?white,sneakers,men,shoes"),
            ("Кожаные ботинки коричневые",7999,"Мужская","Обувь","Классические кожаные ботинки на шнурках","https://source.unsplash.com/400x400/?brown,leather,boots,men"),
            ("Тимберленды жёлтые",8999,"Мужская","Обувь","Легендарные ботинки из нубука","https://source.unsplash.com/400x400/?yellow,timberland,boots,men"),
            # ── Женская / Платья ──
            ("Летнее платье белое",2499,"Женская","Платья","Лёгкое белое платье на лето из шифона","https://source.unsplash.com/400x400/?white,summer,dress,women"),
            ("Вечернее платье чёрное",5499,"Женская","Платья","Элегантное чёрное платье в пол","https://source.unsplash.com/400x400/?black,evening,dress,women,elegant"),
            ("Платье в цветочек",2999,"Женская","Платья","Нежное платье с цветочным принтом","https://source.unsplash.com/400x400/?floral,dress,women"),
            ("Платье-рубашка джинсовое",3299,"Женская","Платья","Стильное джинсовое платье-рубашка","https://source.unsplash.com/400x400/?denim,shirt,dress,women"),
            ("Платье в горошек",2799,"Женская","Платья","Ретро-платье в горошек с поясом","https://source.unsplash.com/400x400/?polka,dot,dress,women"),
            ("Трикотажное платье бежевое",3999,"Женская","Платья","Облегающее тёплое платье из трикотажа","https://source.unsplash.com/400x400/?beige,knit,dress,women"),
            # ── Женская / Юбки ──
            ("Мини-юбка джинсовая",1499,"Женская","Юбки","Стильная джинсовая мини-юбка с пуговицами","https://source.unsplash.com/400x400/?denim,mini,skirt,women"),
            ("Плиссированная юбка розовая",1999,"Женская","Юбки","Нежная миди-юбка-плиссе пастельного цвета","https://source.unsplash.com/400x400/?pink,pleated,skirt,women"),
            ("Юбка-карандаш чёрная",2299,"Женская","Юбки","Классическая юбка-карандаш до колена","https://source.unsplash.com/400x400/?black,pencil,skirt,women"),
            ("Макси-юбка льняная",2799,"Женская","Юбки","Лёгкая длинная юбка из льна для лета","https://source.unsplash.com/400x400/?linen,maxi,skirt,women"),
            # ── Женская / Блузки ──
            ("Шёлковая блузка белая",2299,"Женская","Блузки","Элегантная шёлковая блузка с бантом","https://source.unsplash.com/400x400/?white,silk,blouse,women"),
            ("Блузка в полоску",1799,"Женская","Блузки","Классическая полосатая блузка оверсайз","https://source.unsplash.com/400x400/?striped,blouse,women"),
            ("Кружевная блузка бежевая",2999,"Женская","Блузки","Романтичная блузка с кружевными вставками","https://source.unsplash.com/400x400/?lace,beige,blouse,women"),
            ("Атласная блузка зелёная",2499,"Женская","Блузки","Блузка из атласной ткани изумрудного цвета","https://source.unsplash.com/400x400/?green,satin,blouse,women"),
            # ── Женская / Обувь ──
            ("Туфли на каблуке чёрные",5999,"Женская","Обувь","Классические лодочки на каблуке 8 см","https://source.unsplash.com/400x400/?black,heels,pumps,women,shoes"),
            ("Белые кеды",3499,"Женская","Обувь","Лёгкие белые кеды для ежедневных прогулок","https://source.unsplash.com/400x400/?white,sneakers,women,shoes"),
            ("Ботильоны замшевые бежевые",6999,"Женская","Обувь","Элегантные замшевые ботильоны на каблуке","https://source.unsplash.com/400x400/?beige,suede,ankle,boots,women"),
            # ── Детская / Верхняя одежда ──
            ("Детская куртка красная",2999,"Детская","Верхняя одежда","Яркая демисезонная куртка для детей","https://source.unsplash.com/400x400/?red,jacket,kids,children"),
            ("Зимний комбинезон синий",3999,"Детская","Верхняя одежда","Тёплый зимний комбинезон с капюшоном","https://source.unsplash.com/400x400/?blue,winter,snowsuit,kids"),
            ("Ветровка детская жёлтая",1999,"Детская","Верхняя одежда","Яркая лёгкая ветровка на молнии","https://source.unsplash.com/400x400/?yellow,windbreaker,kids,children"),
            ("Пуховик детский розовый",3499,"Детская","Верхняя одежда","Тёплый пуховик для девочки","https://source.unsplash.com/400x400/?pink,puffer,jacket,girl,kids"),
            # ── Детская / Футболки ──
            ("Футболка с динозавром",599,"Детская","Футболки","Весёлая футболка с принтом динозавра","https://source.unsplash.com/400x400/?dinosaur,tshirt,kids"),
            ("Футболка полосатая детская",699,"Детская","Футболки","Яркая полосатая футболка с длинным рукавом","https://source.unsplash.com/400x400/?striped,tshirt,kids,children"),
            ("Футболка с единорогом",799,"Детская","Футболки","Сказочная футболка с единорогом","https://source.unsplash.com/400x400/?unicorn,tshirt,kids,girl"),
            ("Поло детское белое",899,"Детская","Футболки","Классическое поло для школы и прогулок","https://source.unsplash.com/400x400/?white,polo,shirt,kids"),
            # ── Детская / Брюки ──
            ("Джинсы детские синие",1499,"Детская","Брюки","Удобные джинсы с эластичным поясом","https://source.unsplash.com/400x400/?blue,jeans,kids,children"),
            ("Спортивные штаны детские",999,"Детская","Брюки","Мягкие спортивные штаны из флиса","https://source.unsplash.com/400x400/?sweatpants,kids,children,sport"),
            ("Леггинсы для девочек",799,"Детская","Брюки","Удобные цветные леггинсы для активных детей","https://source.unsplash.com/400x400/?leggings,girl,kids,colorful"),
            # ── Детская / Обувь ──
            ("Кроссовки детские синие",2499,"Детская","Обувь","Лёгкие кроссовки для активных игр","https://source.unsplash.com/400x400/?blue,sneakers,kids,children"),
            ("Ботинки детские коричневые",2999,"Детская","Обувь","Тёплые осенние ботинки на флисе","https://source.unsplash.com/400x400/?brown,boots,kids,children"),
        ]
        c.executemany(
