...
def init_db():
    ...
    if c.fetchone()[0] == 0:
        ...
        products = [
            ...
            # чёрный пуховик с капюшоном
            ("Пуховик зимний чёрный",5999,"Мужская","Верхняя одежда","Тёплый пуховик на зиму с капюшоном","https://images.unsplash.com/photo-1548883354-94bcfe321cbb?w=400"),
            ...
            # парка оливковая/хаки
            ("Парка хаки",6499,"Мужская","Верхняя одежда","Тёплая парка с мехом и капюшоном","https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400"),
            # серый бомбер
            ("Бомбер серый",4999,"Мужская","Верхняя одежда","Стильный бомбер на осень-весну","https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400"),
            # бежевый тренч
            ...
            # синяя стёганая жилетка
            ("Дутая жилетка синяя",3299,"Мужская","Верхняя одежда","Лёгкая стёганая жилетка без рукавов","https://images.unsplash.com/photo-1465877783223-4eba513e27c6?w=400"),
            # ── Мужская / Футболки ──
            ...
            ("Кожаные ботинки коричневые",7999,"Мужская","Обувь","Классические кожаные ботинки на шнурках","https://images.unsplash.com/photo-1638247025967-b4e38f787b76?w=400"),
            # жёлтые тимберленды
            ...
            # ── Женская / Платья ──
            # белое летнее платье
            ("Летнее платье белое",2499,"Женская","Платья","Лёгкое белое платье на лето из шифона","https://images.unsplash.com/photo-1612336307429-8a898d10e223?w=400"),
            ...
            # льняная макси-юбка
            ("Макси-юбка льняная",2799,"Женская","Юбки","Лёгкая длинная юбка из льна для лета","https://images.unsplash.com/photo-1623609163859-ca93c959b98a?w=400"),
            # ── Женская / Блузки ──
            ...
            # бежевая кружевная блузка
            ("Кружевная блузка бежевая",2999,"Женская","Блузки","Романтичная блузка с кружевными вставками","https://images.unsplash.com/photo-1491336477066-31156b5e4f35?w=400"),
            # зелёная атласная блузка
            ...
            # красная детская куртка
            ("Детская куртка красная",2999,"Детская","Верхняя одежда","Яркая демисезонная куртка для детей","https://images.unsplash.com/photo-1604671801908-6f0c6a092c05?w=400"),
            # синий детский зимний комбинезон
            ...
            # розовый детский пуховик
            ("Пуховик детский розовый",3499,"Детская","Верхняя одежда","Тёплый пуховик для девочки","https://images.unsplash.com/photo-1580651315530-69c8e0026377?w=400"),
            # ── Детская / Футболки ──
            ...
            # ── Детская / Брюки ──
            # синие детские джинсы
            ("Джинсы детские синие",1499,"Детская","Брюки","Удобные джинсы с эластичным поясом","https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?w=400"),
            # детские спортивные штаны
            ("Спортивные штаны детские",999,"Детская","Брюки","Мягкие спортивные штаны из флиса","https://images.unsplash.com/photo-1519340241574-2cec6aef0c01?w=400"),
            ...
            ("Кроссовки детские синие",2499,"Детская","Обувь","Лёгкие кроссовки для активных игр","https://images.unsplash.com/photo-1551107696-a4b0c5a0d9a2?w=400"),
            # коричневые детские ботинки
            ("Ботинки детские коричневые",2999,"Детская","Обувь","Тёплые осенние ботинки на флисе","https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=400"),
        ]
        c.executemany(
