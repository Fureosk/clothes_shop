...
def init_db():
    ...
    if c.fetchone()[0] == 0:
        ...
        products = [
            ...
            ("Пуховик зимний чёрный",5999,"Мужская","Верхняя одежда","Тёплый пуховик на зиму с капюшоном","https://images.unsplash.com/photo-1547949003-9792a18a2601?w=400"),
            ...
            ("Бомбер серый",4999,"Мужская","Верхняя одежда","Стильный бомбер на осень-весну","https://images.unsplash.com/photo-1485218126466-34e6392ec754?w=400"),
            ...
            ("Дутая жилетка синяя",3299,"Мужская","Верхняя одежда","Лёгкая стёганая жилетка без рукавов","https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=400"),
            # ── Мужская / Футболки ──
            ...
            ("Кожаные ботинки коричневые",7999,"Мужская","Обувь","Классические кожаные ботинки на шнурках","https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?w=400"),
